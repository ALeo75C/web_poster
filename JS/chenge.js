$('.wint').click(function () {
        $('body').css('background-color', '#F5F7FB');
...
$('.sum').click(function () {
        $('body').css('background-color', '#E0FF80'),('transition', '20s');
...
$('.out').click(function () {
        $('body').css('background-color', '#FCF6B1');
...
$('.sun').click(function () {
        $('body').css('background-color', '#FFF997');
...
$('.win').click(function () {
        $('body').css('background-color', '#89EAED');
